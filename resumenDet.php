		...
		<div class="conte">
			...
			<div class="tabla">
				<?php
					...
					$id=$_GET['id'];
					$solicitud="SELECT *FROM producto P INNER JOIN detalle_venta DV on P.id_producto=DV.id_producto WHERE DV.id_Venta=$id";
					$resultado=mysqli_query($conexion,$solicitud);
					...
					<table border='1' cellspacing="0">
						<thead>
							<tr>
								<td>ID</td><td>MENU</td><td>CANTIDAD</td><td>SUBTOTAL</td>
							</tr>
						</thead>
					<?php
					...
					<div style="float:right;margin-right: 70px;font-size: 1.5em;">
						<b>TOTAL:  S/ <label><?php echo $total; ?></label></b>
					</div>
			</div>
		</div>
